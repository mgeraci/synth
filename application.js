...
(function() {
  var adsr, controlWatchers, init, keyboard, note, noteOff, oscillator, setDefaults;
  ...
  adsr = function() {
    var aNumberOfSteps, aSizeOfSteps, dNumberOfSteps, dSizeOfSteps, i, _i,
      _this = this;
    this.grain = 1;
    this.output = 0;
    ...
    for (i = _i = 0; 0 <= aNumberOfSteps ? _i < aNumberOfSteps : _i > aNumberOfSteps; i = 0 <= aNumberOfSteps ? ++_i : --_i) {
      this.aInnerTimeout = setTimeout(function() {
        _this.output += aSizeOfSteps;
        return _this.gainnode.gain.value = _this.output;
      }, i * this.grain);
    }
    return this.dTimeout = setTimeout(function() {
      var _j, _results;
      _results = [];
  ...
  noteOff = function() {
    var i, rNumberOfSteps, rSizeOfSteps, _i,
      _this = this;
    rNumberOfSteps = this.r / this.grain;
    rSizeOfSteps = this.sl / rNumberOfSteps;
    for (i = _i = 0; 0 <= rNumberOfSteps ? _i < rNumberOfSteps : _i > rNumberOfSteps; i = 0 <= rNumberOfSteps ? ++_i : --_i) {
      this.rInnerTimeout = setTimeout(function() {
        _this.output -= rSizeOfSteps;
        return _this.gainnode.gain.value = _this.output;
      }, i * this.grain);
    }
